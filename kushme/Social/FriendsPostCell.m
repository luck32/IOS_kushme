...
@implementation FriendsPostCell
...
-(void)setData:(NSDictionary *)data {
    ...
    if(data[key_post_date_diff])
        self.timeLabel.text = [NSString stringWithFormat:@"%@ days ago", data[key_post_date_diff]];
